 ...
 */
var albumDictionary = ["Nirvana" : "Nevermnd",
...
print("\(bandName)'s top selling album was \(albumDictionary[bandName])")
/*: question5
 ...
 */
for (band, album) in albumDictionary {
    print("\(band)'s top selling album is \(album)")
}
/*: question6
 ...
 */
for (key, value) in gradeDictionary {
    print("Grade \(key) got an average score of \(value)")
}
/*: question10
